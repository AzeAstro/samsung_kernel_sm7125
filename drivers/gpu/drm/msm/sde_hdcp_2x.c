...
{
	u8 stream_type = 0;
//	static const u8 hdcp_min_enc_level_0 = 0;
//  static const u8 hdcp_min_enc_level_1 = 1;
//  static const u8 hdcp_min_enc_level_2 = 2;
	const u8 stream_type_0 = 0, stream_type_1 = 1;
